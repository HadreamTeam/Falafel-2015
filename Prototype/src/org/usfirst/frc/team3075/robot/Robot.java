...
//    I2C i2c;
    SerialPort serial;
    JoystickButton[] buttons = new JoystickButton[5];
    Joystick stick;
...
//    	talon1.set(stick1.getY()); // will set stick #1 Y value to talon #1
    	...
    	while(true)
    	{
    		try
    		{
//	    		if(!read.contains("999"))
//	    			DriverStation.reportError(read + "\n", false);
	    		...
	    		{
	    			String read = serial.readString(2);
